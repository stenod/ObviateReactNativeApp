...
import {createSleep} from "../src/graphql/mutations";
...
export default class MoodRatingModal extends React.Component {
    ...
    postSleep = async () => {
        ...
        await API.graphql(graphqlOperation(createSleep, todoDetails)).catch(err => console.log(err));
            ...
            <View style={styles.container}>
                <View style={styles.wrap}>
                    <Text style={styles.welcome}>
                        Wie haben sie letze Nacht geschlafen?
                    </Text>
                ...
                <Button title={"Absenden"} onPress={this.postSleep}>
                </Button>
            </View>
        );
    }
